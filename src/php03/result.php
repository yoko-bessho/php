      ...
      <div class="result-cards">
        <div class="result-card">
          <div class="result-card__img-wrapper">
            <img class="result-card__img" src="img/national_flag_img3/<?php echo $tokyo['img']?>" alt="国旗">
          </div>
        ...
        <div class="result-card">
          <div class="result-card__img-wrapper">
            <img class="result-card__img" src="img/national_flag_img3/<?php echo $comparison['img'];?> "alt="国旗">
          </div>
          <div class="result-card__body">
            <p class="result-card__city">
